...
public class GUIAddCourse extends JPanel
{
	...
	public GUIAddCourse()
	{
		...
		lblCourseName.setBounds(102, 113, 111, 14);
		add(lblCourseName);
		...
		lblCourseDesc.setBounds(102, 269, 128, 14);
		add(lblCourseDesc);
		...
		lblDaysOffered.setBounds(102, 144, 111, 14);
		add(lblDaysOffered);
		...
		lblTimeStart.setBounds(102, 175, 111, 14);
		add(lblTimeStart);
		...
		lblTimeEnd.setBounds(102, 206, 111, 14);
		add(lblTimeEnd);
		...
		lblStudentCapacity.setBounds(102, 237, 111, 14);
		...
		fieldCourseName.setBounds(240, 111, 217, 20);
		add(fieldCourseName);
		...
		fieldCapacity.setBounds(240, 235, 217, 20);
		add(fieldCapacity);
		...
		lblCreateCourse.setBounds(222, 51, 243, 21);
		add(lblCreateCourse);
		...
		btnCreate.setBounds(240, 343, 217, 23);
		add(btnCreate);
